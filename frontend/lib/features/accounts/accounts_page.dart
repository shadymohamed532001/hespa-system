        ...
        child: Column(
          ...
          children: [
            ...
            OutlinedButton(
              ...
              child: Text(canDelete ? tr(ar: 'حذف نهائي', en: 'Delete permanently') : tr(ar: 'الحذف النهائي غير متاح', en: 'Permanent delete unavailable')),
            ),
          ],
        ),
      ),
    ...
    final ok = await showHesbaModal<bool>(
      ...
      builder: (ctx) => StatefulBuilder(
        builder: (ctx, setLocal) => HesbaModalCard(
          ...
          subtitle: tr(ar: 'أدخل بيانات الحساب ثم احفظه في النظام.', en: 'Enter account details then save it to the system.'),
            ...
            children: [
              ...
              HesbaModalField(
                ...
                child: DropdownButtonFormField<String>(
                  ...
                  decoration: const InputDecoration(),
                  items: [
                    DropdownMenuItem(value: 'fawry', child: Text(tr(ar: 'فوري', en: 'Fawry'))),
                    DropdownMenuItem(value: 'company', child: Text(tr(ar: 'شركة', en: 'Company'))),
                    DropdownMenuItem(value: 'operating', child: Text(tr(ar: 'تشغيلي', en: 'Operating'))),
                  ],
  ...
  Future<void> _chooseTopUp(BuildContext context) async {
    ...
    final ok = await showHesbaModal<bool>(
      ...
      builder: (ctx) => StatefulBuilder(
        builder: (ctx, setLocal) => HesbaModalCard(
          title: 'شحن الحساب',
          subtitle: tr(ar: 'أضف رصيدًا مباشرًا للحساب المحدد.', en: 'Add balance directly to the selected account.'),
          actions: HesbaModalActions(
            ...
            child: ConstrainedBox(
              ...
              child: DataTable(
                ...
                columns: [
                  ...
                  DataColumn(label: Text(tr(ar: 'الرصيد الحالي', en: 'Current balance'), style: _headerStyle)),
                  DataColumn(
...
String _accountType(String type) =>
    {'fawry': tr(ar: 'فوري', en: 'Fawry'), 'company': tr(ar: 'شركة', en: 'Company'), 'operating': tr(ar: 'تشغيلي', en: 'Operating')}[type] ?? type;
