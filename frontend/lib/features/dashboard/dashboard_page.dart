    ...
    return [
      ...
      ...machines
          ...
          .map(
            (item) => _Asset(
              name: '${item['name']}',
              kind: tr(ar: 'ماكينة شحن', en: 'Top-up machine'),
  ...
  Widget build(BuildContext context) {
    return _Panel(
      child: Column(
        ...
        children: [
          _PanelHeader(
            title: tr(ar: 'آخر الحركات', en: 'Latest movements'),
    ...
    return Container(
      ...
      child: Text(
        hold
            ...
            : internal
            ? category == 'top_up'
                  ? tr(ar: 'شحن مباشر', en: 'Direct top-up')
...
String _walletTypeLabel(String value) =>
    {
      ...
      'we_pay': 'WE Pay',
      'instapay': 'InstaPay',
      'other_wallet': tr(ar: 'محفظة إلكترونية', en: 'E-wallet'),
      'wallet': tr(ar: 'محفظة إلكترونية', en: 'E-wallet'),
    }[value] ??
    value;
